class Score2sController < ApplicationController
  #模考分数 控制器
  ...
  def update
    respond_to do |format|
      if @score.update(simulate_test_score_params)
        ...
        format.html { redirect_to examination_score2s_path(@examination),notice: '学员成绩己记录.'  }
  ...
  private
    ...
    def set_simulate_test_score
      @score = Score2.find(params[:id])
    end

    # Never trust parameters from the scary internet, only allow the white list through.
    def simulate_test_score_params
      params.require(:score2).permit(:examination_id, :student_id,:final_score,

                                    :cr_score,:math_score, :writing_score, :essay_writing_score,

                                    :course_a_score,:course_a1_score,:course_a2_score,:course_a3_score,:course_b_score,:course_c_score,:course_d_score,:course_e_score,

                                    :stat_01,:stat_02,:stat_03,:stat_04,:stat_05,:stat_06,:stat_07,:stat_08,:stat_09,
                                    :stat_10,:stat_11,:stat_12,:stat_13,:stat_14,:stat_15,:stat_16,:stat_17,:stat_18,:stat_19,:stat_20,
